...
function switchView(view) {
  ...
  main.classList.remove("view-gpa", "view-countdown", "view-finance", "view-schedule", "view-routine");
  if (view !== "dashboard") main.classList.add("view-" + view);
  // 渲染对应视图
...
function init() {
  ...
  // 每分钟更新倒计时
  setInterval(() => {
    if (state.currentProfileId && state.currentView === "countdown") renderCountdown();
  }, 60000);
}
